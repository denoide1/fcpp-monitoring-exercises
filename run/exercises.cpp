...
//! @brief Skips printing of map navigator objects.
...
int main() {
    ...
    auto init_v = common::make_tagged_tuple<option::name, option::texture, option::navigator>("Monitoring Exercises", "obstacles.png", obj);
